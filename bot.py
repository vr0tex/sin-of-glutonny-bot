...
class AppDecisionView(discord.ui.View):
    ...
    async def accept_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        await interaction.followup.send(f"Accepted {self.applicant.mention} and gave them the Junior Moderator role.", ephemeral=False)
    ...
    async def reject_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        await interaction.followup.send(f"Rejected {self.applicant.mention}'s application.", ephemeral=False)
...
class ApplyView(discord.ui.View):
    ...
    async def apply_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        try:
            ...
            mod_app_channel = bot.get_channel(MOD_APP_CHANNEL_ID)
            ...
            if mod_app_channel:
                ...
                await user.send("There was an error submitting your application (Moderator application channel not found). Please contact an admin.")
